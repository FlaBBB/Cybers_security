...
def debug():
    ...
    if dp >= 5:
        ...
        for i in range(10):
            if i - 5 == 0:
                print(
                    (f"\033[1;31m[\033[0m{dp+i-5}\033[1;31m]\033[0m".center(29, " ")),
                    " ",
                    end="",
                )
                continue
            else:
                print((f"[{dp+i-5}]".center(7, " ")), " ", end="")
        print(" <<  {dp}  ▏")
        print("▕ -", end="")
        for i in range(10):
            print("---------", end="")
        ...
        for i in range(10):
            if i - 5 == 0:
                print(
                    ((f"\033[1;31m{tape[dp+i-5]}\033[0m").center(18, " ")), "|", end=""
                )
                continue
        ...
        for i in range(10):
            if i == dp:
                print(
                    (f"\033[1;31m[\033[0m{dp}\033[1;31m]\033[0m".center(29, " ")),
                    " ",
                    end="",
                )
                continue
