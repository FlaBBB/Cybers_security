...
// // Define a helper function template to print the values of r and i
// template <typename T>
// void print_values(int x, int y)
// {
//   std::cout << "<" << x << "," << y << "> " << "r = " << T::r << ", i = " << T::i << std::endl;
// }

// // Define a base case for the recursion to terminate
// template <>
// void print_values<void>() {}

// template <typename T>
// void print_row(int x = 0, int y = 0)
// {
//   print_values<typename T::c>(x, y);
//   print_row<typename T::n>(x + 1, y);
// }
...
// // Define a recursive function template to traverse the structure W and print values
// template <typename T>
// void print_all_values(int x = 0, int y = 0)
// {
//   print_row<typename T::c>(x, y);        // Print values for the current C<x, y> struct
//   print_all_values<typename T::n>(x, y + 1); // Recur to print values for the next struct
// }
...
// int main()
// {
//   // Call the recursive function to print values for all C<x, y> structs in W
//   print_all_values<W>();
