...
FLAG = "GCC{D1@b0l1c@l_@n@lyst}"

with open("dataset_dga.txt", "r") as file:
    content = file.read()

dga_domains = content.split("\n")

with open("dataset_legit.txt", "r") as file:
    content = file.read()
...
for i in range(0, 10000, 100):
    ...
    result = input(
        'Enter your analysis - Respect this format : { "labels" : [1,0,0,1...] } - With 1 for dga and 0 for legit : '
    ).strip()
...
if count > 8500:
    ...
    print(
        f"You blocked too many legit domains or didn't block enough malicious domains. Here is your count {count} Try again !"
    )
