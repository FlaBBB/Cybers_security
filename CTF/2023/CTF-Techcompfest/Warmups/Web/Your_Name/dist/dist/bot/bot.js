...
module.exports = {
    ...
    bot: async (urlToVisit) => {
        ...
        try {
            ...
            console.log("the cookies in current page: " + (await page.cookies()).map(c => c.name + "=" + c.value).join("; "))
            console.log(`the cookies in ${CONFIG.APPURL}: ` + (await page.cookies(CONFIG.APPURL)).map(c => c.name + "=" + c.value).join("; "))
