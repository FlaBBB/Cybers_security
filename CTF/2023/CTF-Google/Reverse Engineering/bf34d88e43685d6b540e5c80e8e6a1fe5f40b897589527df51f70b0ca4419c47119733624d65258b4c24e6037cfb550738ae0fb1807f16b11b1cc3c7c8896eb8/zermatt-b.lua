do
	...
	local v4 = v3.bxor
	local function byteXor(par_1, par_2)
		local v26 = 0
		local v27
		while true do
			if (v26 == 1) then
			...
			if (v26 == 0) then
				...
				for v44 = 1, #par_1 do
					table.insert(
						...
						string.char(
							v4(
								string.byte(string.sub(par_1, v44, v44 + 1)),
								string.byte(string.sub(par_2, 1 + ((v44 - 1) % #par_2), 1 + ((v44 - 1) % #par_2) + 1))
							) % 256
						)
					)
				end
	...
	local function VMCall(ByteString, vmenv, ...)
		...
		while true do
			if (v30 == 1) then
				v35, v36, v37, v38 = nil, nil, nil, nil
				v30 = 2
			end
			if (2 == v30) then
				v39 = nil
																				...
																				while true do
																					...
																					if (v149 == 1) then
																						while true do
																							if (v150 == 0) then
																								v151 = v35()
																								if (v34(v151,(157 + 194) - ((923 - (660 + 176)) + 263), 181 - (67 + 113) ) == (0 + 0))
																								then
																									local v176 = 0
																									local v177
																									local v178
															...
															if (v113 == 0) then
																...
																if (v71 == 0) then
																	...
																	while true do
																		...
																		if (0 == v126) then
																			v72 = string.byte(ByteString, v32, v32)
																			v32 = v32 + 1
																			v126 = 1
																		end
																	end
														...
														while true do
															if (v114 == 0) then
																...
																if ((0 - 0) == v74) then
																	...
																	while true do
																		if (v127 == 0) then
																			v75, v76 = string.byte(ByteString, v32, v32 + 2)
																			v32 = v32 + 1 + 1
																			v127 = 1
																		end
																		if (v127 == 1) then
																...
																while true do
																	if (v119 == 0) then
																		v105 =
																			...
																			(v78 -
																				((823 - ((205 - 42) + 14 + 77)) -
																					((2297 - ((6503 - 4634) + 29 + 32)) +
																						57 +
																						27 +
																						117)))
																		return (((v77 % (v105 + v105)) >= v105) and
																			(928 - (214 + 620 + 93))) or
																			(0 - (0 + 0))
																	end
																end
															...
															if (v115 == 0) then
																...
																if (v81 == 0) then
																	...
																	while true do
																		if (v128 == 0) then
																			v82, v83, v84, v85 =
																				string.byte(ByteString, v32, v32 + 1 + 0 + (2 - 0))
																			v32 =
																				v32 +
																				((286 + 595) -
																					(265 + 17 + (2414 - (580 + 1239))))
																			v128 = 1
																		end
																		if (v128 == 1) then
																			v81 = 1
							...
							if (v31 == 0) then
								...
								while true do
									if (v52 == 1) then
										ByteString =
											string.gsub(
											string.sub(ByteString, 5),
											byteXor("\168\122", "\134\84\208\67"),
											function(v86)
															...
															if (v116 == 0) then
																...
																if (v89 == 1) then
																	...
																	while true do
																		...
																		if (v129 == 0) then
																			v90 = string.sub(ByteString, v32, (v32 + v87) - (1 + 0))
																			v32 = v32 + v87
																			v129 = 1
																		end
																	end
																...
																if (v89 == (2 - 0)) then
																	...
																	while true do
																		if (v131 == 0) then
																			...
																			for v163 = 1, #v90 do
																				v91[v163] =
																					string.char(string.byte(string.sub(v90, v163, v163)))
																			end
																			v131 = 1
																		end
																		if (v131 == 1) then
